...
public class SharedPrefHard {

        private static SharedPrefHard sharedPrefHard;
        private SharedPreferences pref;
        private SharedPreferences.Editor editor;
        private final String s = "HARD";

        private SharedPrefHard(Context context) {
            pref = context.getSharedPreferences(s, Context.MODE_PRIVATE);
            editor = pref.edit();
        }
        public static SharedPrefHard getInstance(){
            return sharedPrefHard;
        }
        public static void init(Context context) {
            if (sharedPrefHard == null) {
                sharedPrefHard = new SharedPrefHard(context);
            }
        }
        ...
        public int getFirstSteps(){return pref.getInt("first",0);}
